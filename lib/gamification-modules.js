...
G.registerModule({
  id: 'streak',
  name: 'Daily Streak',
  description: 'Announces your day-over-day activity streak (the streak count itself is always tracked in session state; this module governs whether it\'s announced). CLI-only for now — shown on `gym today`; no webapp view surfaces it yet.',
  default: true,
  on: {
